...
render_config = {
    'scene_xml' : 'infloasion_bunny.xml',        # The filename of xml file to optimize texture
    'cam2origin': 80,                           # Distance between camera and origin
    'mmaps2obj' : 40,
    'camfov' : 'horizontal, 39.6',              # FOV of camera
    'lightsource_texture': 'img/checker.jpg',      # Light source texture
    'ref': 'ref/checker03/infloasion_ref.exr',     # Scene of reference image include only reference texture directly placed to imaging position. 
